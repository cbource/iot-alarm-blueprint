...
- **Open Sensor Check & Arming Confirmation**: Check for open doors/windows upon arming, with configurable modes: actionable `Cancel Arming` / `Bypass & Arm` prompts, warning notifications, or automatic disarming.
